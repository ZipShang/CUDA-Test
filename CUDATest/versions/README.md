...
| [v06_pinned_reuse_kernel_concurrency](v06_pinned_reuse_kernel_concurrency/README.md) | 固定锁页 staging 内存复用，以及质量检测与融合 kernel 并发的单变量对照。 |
...
当前活动实现已对应 `v06_pinned_reuse_kernel_concurrency`；下一轮优化应从上级活动源码继续开发。
